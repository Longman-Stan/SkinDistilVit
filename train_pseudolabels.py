...
pseudolabeled_dataset = ISICDataset("../ISIC2019/ISIC_2019_CuratedTest_GroundTruth.csv", "../ISIC2019/CuratedTestInput", transform=train_transform)
...
train_dataset = ConcatDataset([train_dataset, pseudolabeled_dataset])
...
training_args = TrainingArguments(
    output_dir = "../experiments/ViT_pl_cur",
